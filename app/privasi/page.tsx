  ...
  return (
    <main className="w-full py-12 md:py-20 px-4">
      <article className="max-w-4xl mx-auto text-gray-700 font-sans space-y-12">
        ...
        {/* Pasal 1 */}
        <section>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 tracking-tight">Pengumpulan Data Pribadi</h2>
        ...
        {/* Pasal 2 */}
        <section>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 tracking-tight">Penanganan Pesan Email</h2>
          <p className="text-base md:text-lg leading-relaxed text-justify">
        ...
        {/* Pasal 3 */}
        <section>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 tracking-tight">Penggunaan Cookies & Penyimpanan Lokal</h2>
          <p className="text-base md:text-lg leading-relaxed text-justify">
        ...
        {/* Pasal 4 */}
        <section>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 tracking-tight">Berbagi Data dengan Pihak Ketiga</h2>
          <p className="text-base md:text-lg leading-relaxed text-justify">
        ...
        {/* Pasal 5 */}
        <section>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 tracking-tight">Batasan Tanggung Jawab & Peringatan Keamanan</h2>
          <p className="text-base md:text-lg leading-relaxed text-justify">
        ...
        {/* Pasal 6 */}
        <section>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 tracking-tight">Perubahan Kebijakan</h2>
          <p className="text-base md:text-lg leading-relaxed text-justify">
